...
THIS WAS ARCHIVED ON 09_17_2024 RELATING TO VERSION 0.3.20, WHEN ALL
FIRST VERSIONS OF THE FUNCTIONALITY WAS COMPLETED.
AT THAT POINT WE WANTED TO CLEAN IT UP SO THAT IT WAS EASIER TO TEST THE
NEWER VERSIONS.

THE ASSOCIATED requirements.txt FILE was this:
--extra-index-url https://test.pypi.org/simple/
streamlit>=1.13.0
StreamlitAuth==0.3.20
pandas>=2.2.1
pyyaml>=6.0.1
